    ...
    public partial class MainPage : ContentPage
    {
        ...
        private async void RegisterClicked(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                await DisplayAlert("Success", $"Aramıza Hoş Geldin {user.Info.DisplayName}", "OK");
            ...
            {
                await DisplayAlert("Error", "Kayıt Başarısız", "OK");
            }
        }
        ...
        private async void LoginClicked(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                await DisplayAlert("Success", $"Uygulamaya Hoş Geldin {user.Info.DisplayName} !", "OK");
            ...
            {
                await DisplayAlert("Error", "Kullanıcı Adı Veya Şifre Yanlış", "OK");
            }
        }
    }
